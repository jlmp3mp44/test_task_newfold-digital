...
public class RegistrationTest {
    ...
    public Object[][] createData() {
        return new Object[][]{{"Alla", "Kol", "fr", "ederf", "4562", "UA", "rfrf", "23443", "ewdfwerf", "personal", "3f2g544g", "lwpekdo"},
    ...
    public void testRegistration(String firstName, String lastName, String address, String city, String postCode, String country,
                                 String state, String phone, String email, String accountType, String username, String password) {
        MainPage mainPage = registrationPage.createValidUser(firstName, lastName, address, city, postCode, country, state, phone, email, accountType, username, password);
    ...
    public void testValidationErrors(String firstName, String lastName, String address, String city, String postCode, String country,
                                     String state, String phone, String email, String accountType, String username, String password){
        registrationPage.createInvalidUser(firstName, lastName, address, city, postCode, country, state, phone, email, accountType, username, password);
